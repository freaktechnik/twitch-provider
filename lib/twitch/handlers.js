...
const SUPPORTED_MSG_IDS = [ "subs_on", "subs_off", "slow_on", "slow_off", "r9k_on", "r9k_off", "host_on", "host_off", "timeout_success"; "ban_success" ];
...
// 0 is the first word, 1 is the last word
const ARGUMENT_MAP = {
    hosts_remaining: 0,
    unban_success: 0,
    bad_unban_no_ban: 0,
...
function getArguments(message) {
    ...
    if(message.tags.get("msg-id") in ARGUMENT_MAP) {
        if(ARGUMENT_MAP[message.tags.get("msg-id")] === 0)
