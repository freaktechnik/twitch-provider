...
const TwitchAccount = Class({
    ...
    getConversation: function(name) {
        if(!this.conversations.has(name) && this.isMUCName(name)) {
            ...
            //TODO actually make our own conv type for private convs (sent msgs need to be sent as .w <target> <msg> etc.)
            return Account.prototype.getConversation.call(this, name);
        }
