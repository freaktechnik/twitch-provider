...
const { ID, BADGE_CHANNEL_SPLITTER } = require("./const");
...
function getBadges(msg, account) {
    if(msg.tags.get("subscriber") == "1")
        account.addBadge("sub" + BADGE_CHANNEL_SPLITTER + msg.params[0]);
    else if(account.hasBadge("sub" + BADGE_CHANNEL_SPLITTER + msg.params[0]))
        account.removeBadge("sub" + BADGE_CHANNEL_SPLITTER + msg.params[0]);
    ...
    if(msg.tags.get("mod") == "1")
        account.addBadge("mod" + BADGE_CHANNEL_SPLITTER + msg.params[0]);
    else if(account.hasBadge("mod" + BADGE_CHANNEL_SPLITTER + msg.params[0]))
        account.removeBadge("mod" + BADGE_CHANNEL_SPLITTER + msg.params[0]);
